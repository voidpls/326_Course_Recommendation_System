document.addEventListener('DOMContentLoaded', function() {
    const selectBox = document.getElementById('interestsSelect');
    const optionsContainer = document.getElementById('interestsOptions');
    ...
    saveButton.addEventListener('click', function(e) {
        ...
        // 更新兴趣
        const interestsDisplay = selectedInterests.length > 0 
            ? selectedInterests.join(', ') 
            : 'None';
        document.getElementById('summary-interests').textContent = interestsDisplay;
